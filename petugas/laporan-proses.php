                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 style="color: #b64fc8;" class="m-0 font-weight-bold">DataTables Laporan</h6>
                        </div>
                        <div class="card-body">
                                ...
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="feedback.php?report_id=<?= $row['id'] ?>" class="btn" style="background: #b64fc8; color :#ffff;">Tanggapan</a>
                                            </td>
                                        </tr>
                                    </tbody>
                                    <?php endforeach ?>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <a style="background: #b64fc8; color:#ffff" class="btn" href="../auth/logout.php">Logout</a>
                </div>
            </div>
        </div>
    </div>
