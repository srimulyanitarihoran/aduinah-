...
<head>
    ...
    <style>
        .btn{
            background: linear-gradient(45deg, #0a0c27, #2c3e50, #8e44ad, #2980b9, #16a085, #f39c12);
        }
    </style>
                        ...
                        <div class="col-xl-12 col-lg-7">
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                    <h6 class="m-0 font-weight-bold text">Silahkan masukan data-data yang diminta!</h6>
                                </div>
